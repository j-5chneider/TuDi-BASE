...
<details open>
  <summary class="dropbtn_g">
`r fa("plus-circle", height = "15px", fill="#000")` Forschungsfragen und Ergebnisse__
  </summary>
...
Über alle Studien hinweg zeigte sich, dass <span class="EG-txt">Lernende, die während des Lernens spielerische Elemente anwendeten</span>, mehr lernten als <span class="KG-txt">Lernende, die ohne spielerische Elemente lernten</span>.  

<div class="container-w">
<div class="box49">
![](www/gam_eff.jpg){width=100%}
</div>

<div class="box49">
_Zwei Formulierungen, um die Stärke dieses Unterschieds zu beschreiben:_

* _69% der <span class="EG-txt">Lernenden mit Gamification</span> werden im Lernerfolg über dem Durchschnitt der <span class="KG-txt">Lernenden ohne Gamification</span> sein._ 
* _Der Durchschnitt des Lernerfolgs der <span class="EG-txt">Lernenden mit Gamification</span> lag höher als 69% der <span class="KG-txt">Lernenden ohne Gamification</span>._
...
<details class="noborder">
  <summary class="dropbtn_y">
  __`r fa("info-circle", height = "15px", fill="#fff")` Ergebnisse kurz & knapp__
  </summary>
  <div class="dropdown-content">
_Gamification & fachliche Leistung_  
...
* Fleiß: Die Schülerinnen und Schüler gaben an, dass sie durch die spielerischen Elemente dazu angeregt wurden, sich ambitioniertere Ziele zu setzen und mehr Aufgaben zu erledigen.   </div>
</details>
...
<details>
<summary class="dropbtn_g">
`r fa("plus-circle", height = "15px", fill="#000")` Tiefergehende Informationen für Fortgeschrittene__
</summary>

<details class="noborder">
  <summary class="dropbtn_y">
  __`r fa("info-circle", height = "15px", fill="#fff")` Qualität des Reviews__
  </summary>
  <div class="dropdown-content">
_Was überzeugt?_  
...
<details class="noborder">
  <summary class="dropbtn_y">
  __`r fa("info-circle", height = "15px", fill="#fff")` <a href="www/gam_eval.pdf" style="color:white" target="_blank">Detaillierte Evaluation</a>__
  </summary>
</details>
...
Von der Schnitzeljagd beim Kindergeburtstag bis zu Quests im Online-Game - Kinder und Jugendliche legen eine große Neugierde an den Tag, wenn es darum geht, auf Entdeckungsreise zu gehen und eigene Fragen selbstständig zu beantworten. Beim forschenden Lernen wird genau diese Motivation genutzt und der Lernprozess gezielt unterstützt, sodass sich die Lernenden während des Forschens ihr Wissen selbst erarbeiten können.
...
<details>
  <summary>
  <div class="dropbtn_y">__`r fa("info-circle", height = "15px", fill="#fff")` Was ist forschendes Lernen?__</div>
  </summary>
  <div class="dropdown-content">
  Beim forschenden Lernen nehmen die Schülerinnen und Schüler ihren Lernprozess selbst in die Hand. Sie entwickeln Fragen, sammeln Informationen, bereiten diese auf und präsentieren ihr Ergebnis, das anschließend in der Klasse diskutiert und reflektiert werden kann. Die Lehrkraft kann diese forschenden Lernschritte stark vorstrukturieren (z.B. indem sie den Versuchsaufbau und -ablauf im Chemieunterricht vorgibt) oder bewusst offen lassen (z.B. durch eigene Generierung von Fragen und Vorgehensweisen zum Thema Chatsprache im Deutschunterricht).
...
__Wozu mobile Geräte einsetzen?__  
...
__Das Review “Einsatz einer Metaanalyse zur Aufdeckung der kritischen Aspekte des mobilen forschungsbasierten Lernens.”__   
(von [Yang, Sung und Chang, 2020](https://doi.org/10.1177/0735633119879366))  
  
In der Metaanalyse von Yang, Sung und Chang (2020) wurden zunächst 41 Studien mit insgesamt 3.566 Lernenden untersucht. Im Mittelpunkt der Studien stand die Frage, wie sich forschendes Lernen mit mobilen Geräten auf den Lernerfolg oder affektive Einstellungen (z. B. Motivation) der Lernenden auswirkt. Dabei wurden Lernende, bei denen forschendes Lernen mit mobilen Geräten zum Einsatz kam, jeweils mit einer Kontrollgruppe verglichen. In diesen Kontrollgruppen kam entweder computerbasiertes forschendes Lernen (ohne mobile Geräte), forschendes Lernen ganz ohne Computer oder kein forschendes Lernen zum Einsatz.  
  
Über das Alter der Teilnehmenden an den Studien oder die Länder in denen die Studien durchgeführt werden gibt das Review keine Informationen.   
\

<details>
  <summary>
  <div class="dropbtn_y">__`r fa("info-circle", height = "15px", fill="#fff")` Qualität des Reviews__</div>
  </summary>
  <div class="dropdown-content">
_Was überzeugt?_  
...
* In der Suche nach relevanten Studien wurde lediglich auf publizierte Studien zurückgegriffen und nicht zusätzlich nach unveröffentlichten Arbeiten gesucht. Dies kann dazu führen, dass die Stärke des Effekts überschätzt wird. Hier haben die Autor*innen allerdings nachträglich die Effektstärke nach unten korrigiert (siehe „Forschungsfragen und Ergebnisse“).
...
_„Sind mobile Geräte dazu geeignet forschendes Lernen zu unterstützen?“_  
  
Wird forschendes Lernen durch mobile Geräte unterstützt, kann der Lernerfolg (z.B. bezüglich des Fachwissens, Verstehens, Bewertens) der Schülerinnen und Schüler <u>stark verbessert</u> werden. Schätzt man die zusammengefassten Studien allerdings etwas vorsichtiger ein, was einige Eckdaten zu den Studien nahelegen (s. Details zur Studie), würde man zu dem Schluss kommen, dass der Lernerfolg <u>mittelstark</u> verbessert werden kann. In beiden Fällen ist jedoch festzuhalten, dass ein positiver Einfluss mobiler Geräte auf das forschende Lernen vorliegt.  
\

 _„Wann ist die Unterstützung mit mobilen Geräten besonders effektiv?“_ 
...
* _Steuerung_: <br />Ähnlich verhält es sich bei der Frage, wer den Forschungsprozess steuert: Lehrende, Lernende oder beide gemeinsam? Steuern die Schülerinnen und Schüler den Forschungsprozess mit den mobilen Geräten selbst, dann lernen sie am meisten.
...
Quelle: Yang, J.-M., Sung, Y.-T., & Chang, K.-E. (2020). Use of Meta-Analysis to Uncover the Critical Issues of Mobile Inquiry-Based Learning. Journal of Educational Computing Research, 58(4), 715–746. https://doi.org/10.1177/0735633119879366 
</div>
</div>
