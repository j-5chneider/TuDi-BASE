...
<details>
  <summary>
  <div class="dropbtn">__`r fa("info-circle", height = "25px", fill="#fff")` Was ist Gamification?__</div>
  </summary>
...
__Das Review: "Ist Gamification Blödsinn? Evidenz aus einer Metaanalyse und Synthese von qualitativen Daten im Bildungskontext"__  
...
<details>
  <summary>
  <div class="dropbtn">__`r fa("info-circle", height = "25px", fill="#fff")` Qualität des Reviews__</div>
  </summary>
  <div class="dropdown-content">
_Was überzeugt?_  
...
_„Welche Elemente von Gamification (bspw. Belohnungen bekommen, Ziele setzen) nehmen Lernende als besonders positiv oder negativ wahr?“_ 
...
<details>
  <summary>
  <div class="dropbtn">__`r fa("info-circle", height = "25px", fill="#fff")` Ergebnisse kurz & knapp__</div>
  </summary>
  <div class="dropdown-content">
...
\
Quelle:
Bai, S., Hew, K. F., & Huang, B. (2020). Is gamification “bullshit”? Evidence from a meta-analysis and synthesis of qualitative data in educational contexts. Educational Research Review, 100322.  [https://doi.org/10.1016/j.edurev.2020.100322](https://doi.org/10.1016/j.edurev.2020.100322)
...
<div class="img-txt">Photo by <a href="https://unsplash.com/@thisisengineering?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">ThisisEngineering RAEng</a> on <a href="https://unsplash.com/?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a>
</div>
</div>
...
<div class="content-box" style="margin-left: 10px; margin-right:10px;">
__Auf Entdeckungsreise zum Lernerfolg – mit digitaler Unterstützung__  
...
__Eine Beispiel aus der Schulpraxis__  
...
<div class="dropdownbox">
  <button class="dropbtn">__`r fa("info-circle", height = "25px", fill="#fff")` Was ist forschendes Lernen?__</button>
  <div class="dropdown-content">
...
<div class="box26" style="padding-left: 15px; padding-right: 15px;"> _„Wann ist die Unterstützung mit mobilen Geräten besonders effektiv?“_ 
</div>
