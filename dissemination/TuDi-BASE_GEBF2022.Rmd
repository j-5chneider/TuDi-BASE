...
* bisher nur wenig systematisch im Lehrpersonenbildungssystem verankert  <span class="mysource">[@monitorlehrerbildung.2021]</span><br /><br />`r fa(name = "arrow-right")` informelle Lernsettings als integrale Ressource<br /><br />
...
* forschungsbasiert: Aufbereitung von __Forschungs-synthesen__<br /><br /><br />
...
* Combining real and virtual experiments in science education <span class="mysource">(Wörner, S., Kuhn, J., & Scheiter, K.; under Review)</span><br /><br />
* Computer-based feedback on writing <span class="mysource">(Wagner, S., Schneider, J., & Lachner, A.; in prep.)</span>
...
* Interpretation und Verständnis einer Effektgröße als große Herausforderung
  ...
  - nicht-standardisierte Maße problematisch <span class="mysource">[@kraft.2020]</span><br /><br />
