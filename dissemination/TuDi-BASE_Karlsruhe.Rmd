...
<br /> 
`r fa(name = "chalkboard-teacher", fill="grey")` Folien herunterladen: [**bit.ly/###**](####)
...
<br />
`r fa(name = "book-open", fill="grey")` Strategiepapier "Bildung in der digitalen Welt" der KMK  
<span class="mysource">[@kmk.2016]</span>
...
* Facetten professioneller Handlungskompetenz<br />&nbsp;&nbsp;&nbsp;`r fa(name = "long-arrow-alt-right", fill="grey")`Wissen als Voraussetzung evidenzbasierter Praxis 
...
![](www/tpack.jpg){width=43%}
<span class="mysource">[@mishraetal.2006]</span>


## Lehrpersonenbildung | Forschungssynthesen als Wissensbasis

* Forschungssynthesen als „gesammeltes Wissen“ bzgl. eines Themas ideal für die Lehrpersonenbildung?
* Herausforderungen 
...
## Lehrpersonenbildung | Lösungsansatz durch Wissenschaftskommunikation: Clearinghouse
...
# TüDi-BASE | Clearinghouse für Digitalisierung in der Lehrpersonenbildung
...
2. Erkenntnisse der Forschungsynthese 
3. Für die Praxis (Implikationen, Einordnung, Tools) 

<br /><br />
**Gestaltungsprinzipien**

* Einfachheit und Klarheit in der Sprache <span class="mysource">[@kerweretal.2021]</span>
* Verwendung von "Hedges" [Zitation?] <span class="mysource">[@hendriksetal.2020]</span>
...
2. Experimentelle Studien 
    - Darstellungen von Effektstärken
    - Verständnis & Einordnung der Effekstärkemaße 
